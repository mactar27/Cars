...
export default function ContactPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault()
    setLoading(true)
    // Simulation d'envoi (à connecter à un endpoint réel si nécessaire)
        ...
        <section className="mx-auto max-w-7xl px-6 py-20">
          <div className="grid gap-16 lg:grid-cols-[1fr_1.4fr]">
            ...
            >
              ...
              {/* Map placeholder */}
              <div className="overflow-hidden rounded-2xl border border-border bg-muted/40 h-56 flex items-center justify-center">
